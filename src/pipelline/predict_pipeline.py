...
symtoms_data = pd.read_csv("S:/DS/projects/Disease_prediction_and_health_recommendation_system/data/symtoms_df.csv")
precautions_data = pd.read_csv("S:/DS/projects/Disease_prediction_and_health_recommendation_system/data/precautions_df.csv")
workout_data = pd.read_csv("S:/DS/projects/Disease_prediction_and_health_recommendation_system/data/workout_df.csv")
description_data = pd.read_csv("S:/DS/projects/Disease_prediction_and_health_recommendation_system/data/description.csv")
medications_data = pd.read_csv('S:/DS/projects/Disease_prediction_and_health_recommendation_system/data/medications.csv')
diet_data = pd.read_csv("S:/DS/projects/Disease_prediction_and_health_recommendation_system/data/diets.csv")


df = pd.read_csv("S:/DS/projects/Disease_prediction_and_health_recommendation_system/data/Training.csv")
